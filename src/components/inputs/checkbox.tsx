        ...
        {options.map((option, optionIdx) => (
          <label key={optionIdx} className='flex items-center gap-1'>
            <input
              ...
              value={option.value}
              {...register(fieldName)}
              className='appearance-none flex justify-center items-center size-4 rounded bg-zinc-100 checked:bg-blue-500 text-xs checked:text-blue-50 transition-colors checked:after:content-[_"✓"]'
            />
